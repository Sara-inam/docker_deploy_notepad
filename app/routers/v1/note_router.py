    ...
    for note in notes:
        response_notes.append(
            NoteResponse(
                ...
                voice_message=f"http://localhost:8080/notes/voice/{note.id}" if note.voice_message else None
            )
        )
...
async def create_new_note(
    ...
    if file:
        ...
        db_note.voice_message = f"http://localhost:8080/notes/voice/{db_note.id}"
...
async def update_existing_note(
    ...
    if file:
        ...
        db_note.voice_message = f"http://localhost:8080/notes/voice/{note_id}"
